...
def zad2_two_layer_net(student_id):
    ...
    model.hidden_layer.W[:, 0] = [0.5, 0.6]  # wagi neuronu h1
    model.hidden_layer.W[:, 1] = [-0.7, -0.9]  # wagi neuronu h2
    model.hidden_layer.b[:] = [-0.4, 0.7]  # biasy neuronów h1 i h2
...
if __name__ == '__main__':
    ...
    student_id = 193577         # Twój numer indeksu, np. 102247
